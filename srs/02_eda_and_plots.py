...
plt.tight_layout()
plt.savefig('results/correlation_plot.png', dpi=150, bbox_inches='tight')
plt.close() 
...
plt.savefig('results/vote_average_distribution.png', dpi = 150)
plt.close()
...
plt.savefig('results/ratings_boxplot.png', dpi = 150)
plt.close()
...
plt.tight_layout()
plt.savefig('results/genre_ratings.png', dpi=150)
plt.close()
...
plt.ylabel('Year')
plt.tight_layout()
plt.savefig('results/year_boxplot.png', dpi=150, bbox_inches='tight')
plt.close()
